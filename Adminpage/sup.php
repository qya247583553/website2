...
$sql="select * from `allocate system`.supervisoraccount";
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            <tr class="tbContext">
                                                ...
                                                <td><?php echo $row["SupervsiorPassword"]?></td>
                                                <td><?php echo $row["First_Name"]?></td>
                                                <td><?php echo $row["Last_Name"]?></td>
                                                <form action="Modify%20Supervisors.php" method="post">
                                                    <td><button  class="btn btn-info" value="<?php echo $row["SupID"]?>" name="Update" >Update</button></td>
                                                </form>
                                                <form action="deletesup.php" method="post">
