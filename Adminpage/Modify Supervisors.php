                        ...
                        <div class="col-lg-6">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <form  action="Modifysupervisorfunction.php" METHOD="post">
                                        ...
                                        <div class="form-group">
                                            <label>Password:<?php echo $row['SupervsiorPassword']?></label>
                                            <div>
                                                <input  name="SupPassword" class="form-control" required
                                                       data-parsley-maxlength="30" placeholder="Enter password"/>
                                            </div>
                                        </div>
