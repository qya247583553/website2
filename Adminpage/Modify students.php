                        ...
                        <div class="col-lg-6">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <form  action="Modifystudentfunctions.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>StduentEmail:<?php echo $row['StudentEmail']?></label>
                                            <div>
                                        ...
                                        <div class="form-group">
                                            <label>StduentPassword:<?php echo $row['StudentPassword']?></label>
                                            <div>
                                        ...
                                        <div class="form-group">
                                            <label>firstName:<?php echo $row['Fist_Name']?></label>
                                            <div>
                                                <input  class="form-control" required name="Fist_Name"
