        ...
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="view%20all%20projects.php" class="waves-effect"><i class="dripicons-device-desktop"></i><span> view all projects </span></a>
                    </li>
                    <li>
                        <a href="ADD%20STUDENTPROJECTS.html" class="waves-effect"><i class="dripicons-device-desktop"></i><span> Add Your projects </span></a>
                    </li>
                    <li>
                        <a href="view%20student%20projects.php" class="waves-effect"><i class="dripicons-device-desktop"></i><span> View Your projects </span></a>
                    </li>
                    <li class="has_sub">
                            ...
                            <table style="background-color: slategrey;margin-top: 50px">
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    <tr class="tbContext">
                                        ...
                                        <form action="deletestuProjects.php" method="post">
