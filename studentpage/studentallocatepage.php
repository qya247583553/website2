        ...
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="studentallocatepage.php" class="waves-effect"><i class="dripicons-to-do"></i><span> CHOOSE YOUR SUPERVISOR </span></a>
                    </li>
                    <li>
                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Choose supervisor projects</h3>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="email ">
                                ...
                                ?>
                                <form action="studentchoosesupervisorprojects.php" method="post">
                                        ...
                                        <ul class="message-list">
                                            ...
                                            <li>
                                                <div class="col-mail col-mail-1">
                                                    ...
                                                    <div class="">
                                                        <input type="radio" id="chk19" value="<?php echo $row['SupID']?>" name="choose">
                                                        <label for="chk19" class="toggle"></label>
                                                    </div>
                                                    <a href="#" class="title"><?php echo $row["SupervisorEmail"]?></a>
                                                </div>
                                                <div class="col-mail col-mail-2">
                                                    <a href="#" class="subject"><?php echo $row["SupervisorProjectName"]?>
                                                    </a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        $sql = "select *from supervisorprojects  ";
                        $result = mysqli_query($conn, $sql);
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div>&nbsp;</div>
                            <tr><?php echo $row["SupervisorProjectInfo"]?></tr>
                            <div>&nbsp;</div>
                            <?php
                        }
                        ?>
