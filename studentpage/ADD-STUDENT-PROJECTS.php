                        ...
                        <div class="col-lg-6">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <form  action="Addstudentprojectsfunction.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="StudentEmail" type="text" class="form-control" required placeholder="Type Your Email"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Your project Name</label>
                                            <div>
                                                <input name="StudentProjectName" type="password" id="pass2" class="form-control" required
