...
$sql="select * from desi_spice.sup_projects where sup_id='$sid' ";
        ...
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="ADD%20SUPERVISOR%20PROJECTS.html" class="waves-effect"><i class="dripicons-device-desktop"></i><span> ADD Your projects </span></a>
                    </li>
                    <li>
                        <a href="sup1.php" class="waves-effect"><i class="dripicons-device-desktop"></i><span> view supe projects </span></a>
                    </li>
                    <li>
                        <a href="" class="waves-effect"><i class="dripicons-device-desktop"></i><span> view Your allocate projects with students </span></a>
                    </li>
                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">View Supervisor projects</h3>
                        </li>
                    </ul>
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    <tr class="tbContext">
                                                        ...
                                                        <form action="Modify%20your%20projects.php" method="post">
                                                            <td><button  class="btn btn-info" value="<?php echo $row["ID"]?>" name="update" >Update</button></td>
                                                        </form>
                                                        <form action="deletesupervisorProjects.php" method="post">
                                                            <td><button name="delete" value="<?php echo $row["ID"]?>" class="btn btn-info">Delete</button></td>
                                                        </form>
                                                    </tr>
                                                    <?php
                                                }
