        ...
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="index.html" class="waves-effect"><i class="dripicons-device-desktop"></i><span> CHOOSE YOUR SUPERVISOR </span></a>
                    </li>
                    <li>
                        ...
                        <div class="col-lg-6">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <form action="Modifysupprojectsfunction.php" method="post">
